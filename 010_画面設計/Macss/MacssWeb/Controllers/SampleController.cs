...
namespace MacssWeb.Controllers
{
    ...
    public class SampleController : BaseController
    {
        ...
        public ActionResult CreateConfirm(
            [Bind(Include = "DeleteFlgBool,account_id,account_name,account_name_kana,account_password,group_cd,login_count,login_failure_count,last_login_date,delete_flg,create_id,create_date,update_id,update_date,bumon_cd,basyo_cd,account_password_date,sdek12,ctlfl1")]
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult MultiColFixSample()
        {
            RetrieveAlertParamsToViewBag();
