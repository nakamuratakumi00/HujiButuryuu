...
{
    public class D007Controller : BaseController
    {
        ...
        {
            ViewBag.ConfirmMessage = "Fe注文データを作成します。よろしいですか？";
        ...
        public ActionResult MakeResult()
        {
            ...
            ViewBag.TotalKingaku = String.Format("{0:#,0} 円", 4300);
            ...
            ViewBag.ResultInfoMessage = "作成したFe注文データを共有フォルダーへ保存しました。";
