...
(function (Macss) {
    var Time;
    (function (Time) {
        var MacssTime = /** @class */ (function () {
            function MacssTime(timeElementId) {
                this.decId = timeElementId;
            }
            MacssTime.prototype.configure = function () {
        ...
        Time.MacssTime = MacssTime;
    })(Time = Macss.Time || (Macss.Time = {}));
})(Macss || (Macss = {}));
//# sourceMappingURL=macss.time.js.map