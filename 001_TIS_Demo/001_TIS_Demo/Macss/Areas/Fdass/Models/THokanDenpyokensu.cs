...
{
    [Table("t_hokan_denpyokensu")]
    public class THokanDenpyokensu
    {
        ...
        [Description("インプット日")]
        [Column("INPYMD", Order = 4)]
        [Key]
        public DateTime? Inpymd { get; set; }

        [Description("品番コード")]
        [Column("HINCOD", Order = 5)]
        [Required]
        [Key]
        [MaxLength(8)]
