...
namespace Macss.Areas.Tass.Controllers
{
    ...
    public class MaintHinmeiController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            ViewBag.Ctlfl1 = (await controlRepository.GetDataBySectionAsync(ControlRepository.MControlSection.HinmeiExtraction)).Select(x => new SelectListItem() { Text = x.Kbn + ":" + x.Value1, Value = x.Kbn });
        ...
        [HttpPost]
        [AuthorityActionFilter]
        public async Task<ActionResult> Index(HttpPostedFileWrapper uploadFile, MaintHinmeiViewModel data, string import, string output)
        {
            ...
            try
            {
                ...
                {
                    Value2 = "m_unsou_hinmei_koyuu",
                    Value3 = "Macss.Areas.Tass.Models.MUnsouHinmeiKoyuu"
                };
                StringBuilder sb = new StringBuilder();
                sb.Append("DTMOTO IN ('4', '7')");
                if (data.Ctlfl1 != null)
                {
                    sb.Append(" AND CTLFL1 = '" + data.Ctlfl1 + "'");
                }
                ...
                if (!string.IsNullOrEmpty(output))
                {
                    ...
                    var tableName = "TM_hinmei_" + loginUser;
